...
export function cityHash(id: string): number {
  let h = 0;
...
export function cityRotation(id: string): number {
  let h = 7;
...
export function StationBuilding({ wallHex, roofHex, cityId }: { wallHex: string; roofHex: string; cityId: string }) {
